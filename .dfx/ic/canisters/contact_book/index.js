...
import { idlFactory } from './contact_book.did.js';
export { idlFactory } from './contact_book.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CONTACT_BOOK;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./contact_book.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the contact_book canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./contact_book.did.js")._SERVICE>}
 */
export const contact_book = createActor(canisterId);
